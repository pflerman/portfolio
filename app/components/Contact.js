        ...
        <div className="space-y-8">
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-center gap-3">
              ...
              <a href="mailto:pflerman@gmail.com" className="text-xl text-blue-400 hover:text-blue-300 transition">
                pflerman@gmail.com
              </a>
            </div>
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <p className="text-xl text-gray-300">Buenos Aires, Argentina</p>
            </div>
          </div>
